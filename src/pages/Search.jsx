          ...
          <form onSubmit={onSubmit} className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-32 py-4 bg-white/20 border border-white/30 rounded-full text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
              />
              <button
                type="submit"
